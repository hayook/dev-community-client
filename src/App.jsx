...
export default function App() {
    ...
    return (
        <Routes>
            ...
            <Route path="/share-project" element={ <ShareYourWorkForm><ProjectLinks /></ShareYourWorkForm> } />

            <Route path="/new-question" element={<ShareYourWorkForm><h1>Code Here</h1></ShareYourWorkForm>} />
